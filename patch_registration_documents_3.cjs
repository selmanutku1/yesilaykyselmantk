...
const startMarker = "{/* CONSENTS & CONTRACTS FOR GROUP */}";
const endMarker = "<div className=\"p-4 bg-white border border-gray-200 rounded-xl space-y-3\">";
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  console.log("Successfully replaced convoy consents");
} else {
