...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'kamp-planlama' | 'bungalov' | 'katilimci' | 'kayit' | 'revir' | 'yemekhane' | 'teknik' | 'guvenlik' | 'dokümanlar' | 'ayarlar' | 'maliyet' | 'anket-analizi' | 'anket-yonetimi' | 'sistem-loglari' | 'dijital-arsiv' | 'olay-kayit' | 'raporlar' | 'sistem-guncellemeleri' | 'kahoot'>('dashboard');
  ...
  const hasAccess = (tab: 'dashboard' | 'kamp-planlama' | 'bungalov' | 'katilimci' | 'kayit' | 'revir' | 'yemekhane' | 'teknik' | 'guvenlik' | 'dokümanlar' | 'ayarlar' | 'maliyet' | 'anket-analizi' | 'anket-yonetimi' | 'sistem-loglari' | 'dijital-arsiv' | 'olay-kayit' | 'raporlar' | 'sistem-guncellemeleri' | 'kahoot') => {
    if (!currentUser) return false;
    const access = (tab === 'kamp-planlama' && (currentUser.role === 'admin' || currentUser.role === 'mudur' || currentUser.role === 'gonullu')) ||
                   currentUser.role === 'admin' ||
                   currentUser.allowedTabs.includes(tab);
